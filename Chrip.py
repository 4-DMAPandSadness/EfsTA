import numpy as np
import scipy.optimize, scipy.interpolate as sco, sci

def correction(parameters):
    pass

#for sample data / bg
# getData -> splitData -> removeNaN -> truncate -> removeBG
...
######################Basis Funktionen#########################################
    ...
    def correctShift(self, shift):
        ...
        for i in len(data_c[0]):
            ...
            data_cc[i,:] = sci.PchipInterpolator(time, data_c[i,:], t_shift)
